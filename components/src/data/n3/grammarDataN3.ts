export const grammarDataN3 = [
  {
    ...
    connection: "동사(사전형/ている형/ない형), い형용사, な형용사, 명사(의)",
    ...
    contents: [
      {
        ...
        example_kr: "잊어버리기 전에(잊지 않은 동안에), 중요한 것을 메모해 둡시다.",
        highlight: "うちに"
      },
      {
        index: 2,
  ...
  },
  {
    ...
    connection: "보통형 (나형용사, 명사(의)) + せい (으로/탓으로)",
    nuance: "어떤 나쁜 결과에 대한 원인이나 책임을 돌릴 때 사용하며, 탓을 하는 느낌이 강함.",
    contents: [
      {
        index: 1,
        type: "blank",
      ...
      },
      {
        ...
        type: "order",
        label: "비로 인한 축제 중지",
        segments: ["雨が", "降り続いている", "せいで、", "今年の夏祭りは 中止されました。"],
        answer: 2,
  ...
  },
  {
    ...
    connection: "보통형 (나형용사, 명사(나)) + もの/もん",
    ...
    contents: [
      {
        ...
        type: "blank",
        label: "깜빡한 숙제",
        example_jp: "宿題を 完全に忘れてしまったものだから、先生に怒られてしまいました。",
        example_kr: "숙제를 완전히 잊어버렸던 것이라, 선생님께 혼나고 말았습니다.",
        highlight: "もの"
      },
      {
        index: 2,
  ...
  },
  {
    ...
    connection: "보통형 (나형용사(나/である), 명사(의/인것/である)) + ため (에/다)",
    ...
    contents: [
      {
        ...
        type: "blank",
        label: "시설의 사정",
        example_jp: "冷蔵庫の状態が悪いという理由で、急に店を休むことにしました。",
        example_kr: "냉장고 상태가 나쁘다는 이유 때문에, 갑자기 가게를 쉬기로 했습니다.",
        highlight: "ため"
      },
      {
        index: 2,
  ...
  },
  {
    ...
    connection: "보통형 (나형용사, 명사(나)) + のだから / のですから / んだから / んですから",
  ...
  },
  {
    ...
    connection: "동사(た형) + ことをきっかけに, 명사 + をきっかけに",
    ...
    contents: [
      {
        ...
        type: "blank",
        label: "이야기 요약",
        example_jp: "君の話をまとめると、つまり来週から一週間休みがほしいというわけだね。",
      ...
      },
      {
        ...
        example_kr: "사토 씨는 3년이나 해외에서 일했던 건가요? 어쩐지 영어가 능숙한 법이네요.",
        highlight: "わけだ"
      },
      {
        index: 3,
        type: "order",
        label: "머리색이 멋진 이유",
        segments: ["彼女は", "美容師だそうだ。", "だから髪の色が", "素敵なわけですね。"],
        answer: 3,
  ...
  },
  {
    ...
    contents: [
      ...
      },
      {
        ...
        answer: 2,
        example_kr: "처음으로 해외여행을 간 이래로, 다른 문화의 차이에 흥미를 갖게 되었다."
      }
    ],
  ...
  },
  {
    ...
    nuance: "어떤 사태나 현상이 발생하게 된 원인이나 이유를 나타낼 때 사용하며, 격식 있는 표현에 주로 쓰임.",
    contents: [
      {
        index: 1,
        type: "blank",
      ...
      },
      {
        ...
        type: "blank",
        label: "독서의 즐거움을 깨달음",
        example_jp: "この素晴らしい本に出会ったことによって、本を読む楽しさを知ることができた。",
  ...
  },
  {
    ...
    connection: "동사(た형/ない형), い형용사, な형용사, 명사(의) + まま",
  ...
  },
  {
    ...
    connection: "동사(사전형), 명사(인것/である) + とともに",
    ...
    contents: [
      {
        ...
        type: "blank",
        label: "두 가지 관계의 공존",
        example_jp: "彼女は私에 日本語를 가르쳐 주는 선생님인 동시에, 좋은 친구이기도 합니다.",
  ...
  },
  {
    ...
    contents: [
      ...
      },
      {
        ...
        type: "order",
        label: "병의 회복 과정",
        segments: ["彼の病気は", "少しずつ", "回復しつつある가, ", "아직 통원 치료가 필요한 듯하다."],
        answer: 2,
