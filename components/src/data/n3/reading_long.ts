...
export const n3ReadingLong: ReadingQuestion[] = [
  {
    ...
    passage: "私たちは、失敗することを怖がります。しかし、失敗を全くしない人は、新しいことに挑戦していない人だとも言えます。失敗したときは、「なぜ失敗したのか」をじ집중해서 생각할 기회입니다. 중요한 것은 실패를 숨기는 것이 아니라, 그것을 다음 성공을 위한 데이터로 활용하는 긍정적인 자세입니다.", 
    // (본문은 예시를 위해 축약함)
    ...
    questions: [
      {
        ...
        options: [
          ...
          "失敗를 숨기는 것이 가장 좋은 해결 방법이다."
        ],
        answer: 1, // 2번째 보기
        explanation: "실패를 다음 성공을 위한 '데이터'로 활용하라는 긍정적 태도를 강조하고 있습니다.",
        evidence: "それを次の成功のためのデータとして活用する前向きな姿勢なのです。",
